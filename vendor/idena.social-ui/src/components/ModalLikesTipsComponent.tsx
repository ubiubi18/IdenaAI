                        ...
                        <li className="pl-2 pr-3">
                            <div className="h-7 flex flex-row">
                                ...
                                <div className="flex flex-col justify-center">
                                    <p className="text-[10px]/6 text-stone-500 font-[700]"><a href={`https://scan.idena.io/transaction/${item.txHash}`} target="_blank" rel="noopener noreferrer">{`${displayDate}, ${displayTime}`}</a></p>
                                </div>
                            </div>
