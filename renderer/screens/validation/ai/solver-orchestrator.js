...
const SHORT_SESSION_SAFE_SUBMIT_GUARD_MS = 10 * 1000
...
export async function solveValidationSessionWithAi({
  ...
  function buildSolvedDecision({payloadFlip, index, solved}) {
    ...
    return {
      ...
      probabilities: solved.probabilities || null,
      probabilityEnsemble: solved.probabilityEnsemble || null,
      ensembleProbabilities: solved.ensembleProbabilities || null,
